...
LangChainやOpenAIを活用したAIチャットボット、55言語対応の音声テキスト変換、PDFチャット機能、画像分析ボット、Spotify連携など、20種類のTelegram自動化テンプレートをご覧ください。サポート、マーケティング、コンテンツモデレーションなどのユースケースに対応しています。
...
| Internship Informer | AIを使用してTelegramチャンネルからインターンシップの募集情報を抽出・解析し、Firecrawl経由で応募ページをスクレイピングして要件をフィルタリングし、WhatsAppで通知します。 | 人事/運用 | [Link to Template](Telegram/Internship%20Informer.json) |
| Resume Bot | Telegram上のAI搭載履歴书・カバーレターアシスタント。PDF履歴書の解析、Supabase上のユーザープロフィールの更新、SSH経由でのカスタマイズされたLaTeX履歴書のコンパイルを行います。 | 人事/運用 | [テンプレートへのリンク](Telegram/ResumeBot.json) |
